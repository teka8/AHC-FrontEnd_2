...
export default function ScholarshipHome() {
  ...
  const upcomingScholarships = scholarships.filter(s => s.status === 'upcoming')

  return (
    <>
      <Helmet>
        <title>Scholarship Portal - AHC</title>
        <meta name="description" content="Apply for health innovation scholarships" />
      </Helmet>
      ...
      <div className="min-h-screen">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <p className="text-xl mb-8">
                Empowering the next generation of health innovators through education and support
              </p>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            {!isLoading && scholarships.length > 0 && (
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {scholarships.map((scholarship) => (
                  <div key={scholarship.id} className="border rounded-lg p-6 hover:shadow-lg transition">
                    <div className="flex items-center justify-between mb-4">
                      <h3 className="text-xl font-semibold">{scholarship.title}</h3>
                      <span className={`px-3 py-1 text-sm rounded-full ${statusStyles[scholarship.status]}`}>
                    ...
                    <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400 mb-6">
                      <div className="flex items-center gap-2">
                        ...
                        <span>
                          Deadline: {dayjs(scholarship.deadline).format('MMMM D, YYYY')}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="capitalize">{scholarship.program_type}</span>
                      </div>
            ...
            {!isLoading && scholarships.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-600 dark:text-gray-400 mb-4">No scholarships available at the moment</p>
