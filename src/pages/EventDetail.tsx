  ...
  return (
    <div className="container pt-24 pb-16 md:pb-24">
      <Helmet>
          ...
          content={
            data?.description
              ? String(data.description)
                  .replace(/<[^>]+>/g, "")
                  .slice(0, 160)
              : "Event details at Africa Health Collaborative (AHC)."
          }
        />
        <meta name="author" content="Africa Health Collaborative" />
        <meta
          property="og:title"
          content={`${data?.title ?? "Event"} – Africa Health Collaborative`}
        />
        <meta
        ...
        <meta
          property="og:url"
          content={`https://ahc.tewostechsolutions.com/events/${id}`}
        />
        <meta
          property="og:image"
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-md">
              ...
              <ul className="text-sm text-slate-700 dark:text-slate-300 space-y-3">
                <li>
                  ...
                  {data.event_date
                    ? dayjs(data.event_date).format("MMMM DD, YYYY")
                    : "TBA"}
                </li>
                ...
                {typeof data.cost_amount !== "undefined" &&
