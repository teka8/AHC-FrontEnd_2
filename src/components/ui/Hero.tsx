...
const slides = [
  {
    ...
    ctaLink: "/contact",
    secondaryCtaText: "Portal",
    secondaryCtaLink: "https://ahcadmin.aau.edu.et/admin/login",
  },
  {
    id: 2,
  ...
  {
    id: 3,
    image: "images/hero/Inovation.jpg",
  ...
  },
  {
    ...
    accent: "bg-amber-500",
    textAccent: "text-amber-600",
    ctaText: "Health Employment",
    ctaLink: "/health-pillars/health-employment",
