        ...
        <div className="flex items-start gap-6">
          {date && (
            <div className="flex-shrink-0 text-center bg-ahc-green-light dark:bg-ahc-green-dark rounded-lg p-3 w-20">
              <div className="text-3xl font-bold font-display text-ahc-green-dark dark:text-white">
                {date.format("DD")}
              </div>
              <div className="text-sm font-semibold text-ahc-green-dark dark:text-ahc-green-light">
                {date.format("MMM")}
              </div>
            </div>
          )}
