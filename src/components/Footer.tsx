...
export default function Footer() {
  ...
  return (
    <footer className="relative mt-16 text-slate-600 bg-gradient-to-b from-white to-slate-50 border-t overflow-x-hidden">
        ...
        <div className="grid gap-10 md:grid-cols-4">
          <div className="space-y-3">
            ...
            <div className="flex gap-3 pt-2">
              <a href="#" className="p-2 rounded-full border hover:bg-white transition" aria-label="Twitter">
              ...
              <a href="#" className="p-2 rounded-full border hover:bg-white transition" aria-label="Facebook">
              ...
              <a href="#" className="p-2 rounded-full border hover:bg-white transition" aria-label="LinkedIn">
          ...
          <div className="grid grid-cols-2 gap-6 md:col-span-2">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/resources" className="hover:text-slate-900 transition">Resources</a></li>
                <li><a href="/news" className="hover:text-slate-900 transition">News</a></li>
                <li><a href="/events" className="hover:text-slate-900 transition">Events</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-3">Explore</h4>
              <ul className="space-y-2 text-sm">
                <li><a href="/resources#documents" className="hover:text-slate-900 transition">Document Repository</a></li>
                <li><a href="/resources#educational" className="hover:text-slate-900 transition">Educational Hub</a></li>
                <li><a href="/resources#others" className="hover:text-slate-900 transition">Other Resources</a></li>
          ...
          <div>
            ...
            <p className="max-w-sm text-sm">{data?.contact ?? 'Addis Ababa University, Ethiopia'}</p>
            <div className="mt-4">
              <form className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-2 max-w-md justify-items-start">
                <input
                  type="email"
                  placeholder="Your email"
                  className="w-full rounded-full px-4 py-2.5 md:py-3 bg-white border border-slate-300 shadow-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-ahc-green/40 focus:border-ahc-green/50"
                />
                <button className="btn">Subscribe</button>
              </form>
              <p className="mt-2 text-xs text-slate-500">Stay updated with news and events.</p>
            </div>
          </div>
        </div>
        <div className="mt-10 text-xs text-slate-500">© {new Date().getFullYear()} AHC-AAU. All rights reserved.</div>
      </div>
    </footer>
  )
}
